...
public class Test_MessageHelpers_ErrorJson
{
    ...
    {
        var json = ESB.Helpers.MessageHelpers.ErrorJson("Entity not found");
    ...
    {
        var json = ESB.Helpers.MessageHelpers.ErrorJson("test message");
    ...
    {
        var json = ESB.Helpers.MessageHelpers.ErrorJson("test");
        var obj = JObject.Parse(json);
    ...
    public void ExceptionJson_ContainsErrorMessage()
    {
        ...
        var json = ESB.Helpers.MessageHelpers.ExceptionJson(ex);
        var obj = JObject.Parse(json);
    ...
    {
        var json = ESB.Helpers.MessageHelpers.ExceptionJson(new Exception("x"));
        var obj = JObject.Parse(json);
...
public class Test_MessageHelpers_VectorShape
{
    ...
    {
        // This is the canonical output format of ESB.Helpers.MessageHelpers.Vec(Vector3)
    ...
    {
        // This is the canonical output format of ESB.Helpers.MessageHelpers.Vec(VectorInt3)
    ...
    {
        // This is the canonical output format of ESB.Helpers.MessageHelpers.Vec(Quaternion)

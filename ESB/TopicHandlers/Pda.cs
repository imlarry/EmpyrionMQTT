...
namespace ESB.TopicHandlers
{
    public class Pda : IPda
    {
        ...
        {
            _ctx.Messenger.RegisterHandler("Pda.ShowMessage",           ShowMessage);
            _ctx.Messenger.RegisterHandler("Pda.ShowDialog",            ShowDialog);
            _ctx.Messenger.RegisterHandler("Pda.GiveReward",            GiveReward);
            _ctx.Messenger.RegisterHandler("Pda.SpawnDropBox",          SpawnDropBox);
            _ctx.Messenger.RegisterHandler("Pda.SetMapMarker",          SetMapMarker);
            _ctx.Messenger.RegisterHandler("Pda.GetPoiLocation",        GetPoiLocation);
            _ctx.Messenger.RegisterHandler("Pda.GetPoiEntityId",        GetPoiEntityId);
            _ctx.Messenger.RegisterHandler("Pda.GetBlockLocation",      GetBlockLocation);
            _ctx.Messenger.RegisterHandler("Pda.GetBlockName",          GetBlockName);
            _ctx.Messenger.RegisterHandler("Pda.SpawnPrefabAtBlock",    SpawnPrefabAtBlock);
            _ctx.Messenger.RegisterHandler("Pda.SpawnPrefabAtPosition", SpawnPrefabAtPosition);
            _ctx.Messenger.RegisterHandler("Pda.SpawnEntityAtPosition", SpawnEntityAtPosition);
            _ctx.Messenger.RegisterHandler("Pda.CreateWaveAttack",      CreateWaveAttack);
            _ctx.Messenger.RegisterHandler("Pda.CreateId",              CreateId);
            _ctx.Messenger.RegisterHandler("Pda.Activate",              Activate);
        }
        ...
        // -----------------------------------------------------------------------
        // Pda.ShowMessage — displays a message at the bottom-centre of the HUD
        ...
        // -----------------------------------------------------------------------
        // Pda.ShowDialog — shows an interactive PDA dialog with a preset button set
        ...
        // -----------------------------------------------------------------------
        // Pda.GiveReward — gives a reward to the specified player
        ...
        // -----------------------------------------------------------------------
        // Pda.SpawnDropBox — spawns a drop container at the specified world position
        ...
        // -----------------------------------------------------------------------
        // Pda.SetMapMarker — creates or removes a temporary map marker for a player
        ...
        // -----------------------------------------------------------------------
        // Pda.GetPoiLocation — world position of a named POI
        // Payload: { "PoiName": "..." }
        ...
        // -----------------------------------------------------------------------
        // Pda.GetPoiEntityId — entity ID of a named POI
        // Payload: { "PoiName": "..." }
        ...
        // -----------------------------------------------------------------------
        // Pda.GetBlockLocation — local and world positions of a named block on an entity
        ...
        // -----------------------------------------------------------------------
        // Pda.GetBlockName — human-readable name for a block type value
        // Payload: { "BlockVal": n }
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Pda.SpawnPrefabAtBlock — spawn a prefab at the location of a named block
        ...
        // -----------------------------------------------------------------------
        // Pda.SpawnPrefabAtPosition — spawn a prefab at a world position
        ...
        // -----------------------------------------------------------------------
        // Pda.SpawnEntityAtPosition — spawn an entity at a world position
        ...
        // -----------------------------------------------------------------------
        // Pda.CreateWaveAttack — creates a wave attack from the provided parameters
        ...
        // -----------------------------------------------------------------------
        // Pda.CreateId — creates a script-internal integer ID from a title string
        // Payload: { "Title": "..." }
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Pda.Activate — executes the PDA script (TBD per API docs)
        // Payload: { "Reset"?: false }
        // -----------------------------------------------------------------------

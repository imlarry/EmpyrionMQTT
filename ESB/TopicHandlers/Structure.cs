...
namespace ESB.TopicHandlers
{
    public class Structure : IStructure
    {
        ...
        // -----------------------------------------------------------------------
        // Structure.Info — all scalar IStructure properties
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.Tanks — FuelTank, OxygenTank, PentaxidTank
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetAllCustomDeviceNames — returns string[] of named devices
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetDevicePositions — block positions for a named device
        ...
        // -----------------------------------------------------------------------
        // Structure.GetDockedVessels — entity IDs of all docked vessels
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetPassengers — players currently aboard
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetBlockSignals — all block-sourced sender signals
        ...
        // -----------------------------------------------------------------------
        // Structure.GetControlPanelSignals — control panel defined signals
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetSignalState — current on/off state of a named signal
        ...
        // -----------------------------------------------------------------------
        // Structure.GetSignalReceivers — blocks that listen to a named signal
        // Payload: { "EntityId": n, "SignalName": "MySignal" }
        // -----------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------
        // Structure.GetSendSignalName — signal name at a block position, or null
        ...
        // -----------------------------------------------------------------------
        // Structure.StructToGlobalPos — local block position → world position
        ...
        // -----------------------------------------------------------------------
        // Structure.GlobalToStructPos — world position → local block position

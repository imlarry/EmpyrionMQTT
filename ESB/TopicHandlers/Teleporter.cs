...
namespace ESB.TopicHandlers
{
    public class Teleporter : ITeleporter
    {
        ...
        {
            _ctx.Messenger.RegisterHandler("Teleporter.Get", Get);
            _ctx.Messenger.RegisterHandler("Teleporter.Set", Set);
        }
        ...
        // TeleporterData → JSON: TargetEntityNameOrGroup, TargetPlayfield,
        //                        TargetSolarSystemName, Origin (byte)
        ...
        // -----------------------------------------------------------------------
        // Teleporter.Get — read the target configuration of a teleporter or portal
        // Payload: { "EntityId": n, "Pos": {"X":0,"Y":0,"Z":0} }
        // Response: { EntityId, Pos, TargetEntityNameOrGroup, TargetPlayfield,
        //             TargetSolarSystemName, Origin }
        ...
        // -----------------------------------------------------------------------
        // Teleporter.Set — write the target configuration of a teleporter or portal
        // Payload: { "EntityId": n, "Pos": {...},
        //            "TargetEntityNameOrGroup": "deviceName@structName",
        //            "TargetPlayfield": "Akua",
        //            "TargetSolarSystemName": "Omicron",
        //            "Origin": 255 }
        // All TargetData fields are optional; omitted fields default to null / 0xff.
        // -----------------------------------------------------------------------

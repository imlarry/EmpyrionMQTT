...
{
    // Shared helpers for ESB/ schema handlers.
    internal static class HandlerHelper
    {
        ...
        // Replaces the dir segment with "Err": ESB/{type}/{connId}/{scope}/Err/{op}
        internal static async Task ReplyErrorAsync(IMessenger messenger, MessageContext ctx, string errorJson)
        {
            ...
            string errTopic = pt.DeviceName != null
                ? $"ESB/{pt.ParticipantType}/{pt.ConnectionId}/Structure/Device/{pt.DeviceName}/Err/{pt.Operation}"
                : $"ESB/{pt.ParticipantType}/{pt.ConnectionId}/{pt.Scope}/Err/{pt.Operation}";
